...
def popularity(agent, other_agent, discovery, cooperation_threshold, logger):
    # other agent does ...
    # other_agent has to get all recommendations about itself
    agents_to_ask = [third_agent for third_agent in discovery if third_agent != other_agent and direct_experience(other_agent, third_agent, logger) >= cooperation_threshold]
