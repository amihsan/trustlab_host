...
class AgentServer(Thread):
    def run(self):
        ...
        while not self._stop_event.isSet():
            ...
            new_thread = ClientThread(conn, self.agent, self.agent_behavior, self.trust_thresholds, self.logger,
    ...
    def __init__(self, agent, ip_address, port, agent_behavior, trust_thresholds, logger,
                 observations_done):
